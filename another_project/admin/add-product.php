                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea required name="small_description" placeholder="Enter small description" rows="3" class="form-control mb-2"></textarea>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea required name="meta_description" placeholder="Enter meta description" rows="3" class="form-control mb-2"></textarea>
                            </div>
                            <div class="col-md-12">
                                <label class="mb-0">Meta Keywords</label>
                                <textarea required name="meta_keywords" placeholder="Enter meta keyword" rows="3" class="form-control mb-2"></textarea>
                            </div>
                    
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" required name="add_product_btn">Save</button>
                            </div>
                        </div>
                    </form>
                </div>

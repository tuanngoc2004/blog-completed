                    ...
                    <div class="card-body">
                        <form action="functions/authcode.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="phone" class="form-control" placeholder="Enter your your phone number">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="cpassword" class="form-control" placeholder="Confirm Pass">
                            </div>
